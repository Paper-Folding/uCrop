package ling.paper.othersavatardemo;
    ...
    private void setupUI() {
        ...
        findViewById(R.id.button_random_image).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse(String.format(Locale.getDefault(), "https://picsum.photos/%d/%d/?random",
        ...
        mSeekBarQuality.setProgress(100);
